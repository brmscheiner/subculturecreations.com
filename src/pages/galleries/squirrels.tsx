  ...
  description: (
    <>
      <p>
        ...
        persistent enough to follow me for at two full blocks and fearless
        enough to cross the street. A cat noticed his strange behavior and
        attacked him. I shooed the cat away and took the squirrel home in a
        shoebox.
      </p>
      <p className='mt-3'>
